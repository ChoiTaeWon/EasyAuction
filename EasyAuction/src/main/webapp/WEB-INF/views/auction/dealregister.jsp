				...
				<form action="dealregister.action" method="POST" enctype="multipart/form-data" id='regiform' name="auction" style="margin:0;">
											...
											<table width="100%">
												...
												<tr height="30">
													<td width="150" style="background-color:#F6F6F6;">
														<img src="/easyauction/resources/images/ico_dot.gif" style="margin-left:10px;margin-right: 10px;" align="absmiddle"><b>제목</b>
													</td>
												...
												<tr height="30">
													<td width="150" style="background-color:#F6F6F6;">
														<img src="/easyauction/resources/images/ico_dot.gif" style="margin-left:10px;margin-right: 10px;" align="absmiddle"> <b>카테고리</b>
													</td>
													<td width="800" style="padding-left:10px;">	
												...
												<!-- 입찰 시작 일시 -->
												<tr height="60">
													<td width="150" style="background-color:#F6F6F6;"><img src="/easyauction/resources/images/ico_dot.gif" style="margin-left:10px;margin-right: 10px;" align="absmiddle"><b>입찰시작일시</b></td>
													<td width="800" style="padding-left:10px;">
												...
												<tr height="60">
													...
													<td width="800" style="padding-left:10px;">
															...
															<div style="padding-top:5px;"><img src="img/icon_detail_dot.gif"></div></td> -->
												</tr>
												<tr>
													<td colspan="2" style="height:1px; background:url(img/line_02.gif); width:100%;"></td>
												</tr>
												...
												<!-- 입찰 시작 가격 -->
												<tr height="60">
													<td width="150" style="background-color:#F6F6F6;"><img src="/easyauction/resources/images/ico_dot.gif" style="margin-left:10px;margin-right: 10px;"  align="absmiddle"><b>경매 시작가</b></td>
								...
								<tr>
									<td style="padding:5px;">
										...
										<table style="width: 100%;border-bottom: 1px solid #f6f6f6">
												<tr>
