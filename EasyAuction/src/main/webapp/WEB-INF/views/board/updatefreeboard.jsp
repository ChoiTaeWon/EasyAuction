	...
	<div id="wrap"> <!-- A 시작 -->
		...
		<div style="width: 960px; "><!-- 헤더밑 부분 margin:0 auto;-->
			...
			<tr height="30">
				...
				<form method='post' action='updatefreeboard.action' enctype="multipart/form-data">
				...
				<tr>
					<td>
						...
						<tr height="28">
							...
							<td bgcolor="#FFFFFF" style="padding-left:10px; padding-top:5px"><textarea name="content" cols="100" rows="20" style='font-size:12px; background-color:white; border:1px; border-style:solid;border-color:#DDDDDD;'>${ view.bdContent }</textarea></td>
						</tr>
