			...
			<tr height="30">
				...
				<table width="100%">
				 ...
				 <table width="100%">
					...
					<tr>
						...
						<!-- 내용 옆 수정 삭제 -->
						<td align="right"><a href='/easyauction/board/updategongji.action?bdno=${ view.bdNo }&pageno=${ pageno }'><img src='/easyauction/resources/images/sujung.png'></a>
										  <a href='/easyauction/board/deletegongji.action?bdno=${ view.bdNo }&pageno=${ pageno }'><img src='/easyauction/resources/images/delete.png'></a>
						</td>
				...
				<table border='0' width='100%' cellspacing='0' cellpadding='0'>
					<tr>
						...
						<td width='600' align='left'>${ comment.bcContent }&nbsp;&nbsp;<font color='#cacaca' style='font-size:11px;'>${ comment.bcRegdate }</font>
						<!-- 댓글 옆 수정 삭제 -->
						<td align="right"><a href='/easyauction/board/updategongjicomment.action?bdno=${ view.bdNo }&bcno=${ comment.bcNo }&pageno=${ pageno }'><img src='/easyauction/resources/images/sujung.png'></a>
										  <a href='/easyauction/board/deletegongjicomment.action?bdno=${ view.bdNo }&bcno=${ comment.bcNo }&pageno=${ pageno }'><img src='/easyauction/resources/images/delete.png'></a>
						</td>
